...
`hltGetConfiguration /online/collisions/2017/2e34/v4.2/HLT/V6 --input /store/mc/RunIISummer17DRStdmix/SingleMu_Pt1To1000_FlatRandomOneOverPt/AODSIM/NZSNoPU_92X_upgrade2017_realistic_v10-v2/10000/06AAD71C-829F-E711-9B00-6CC2173C39E0.root --paths HLTriggerFirstPath,HLT_IsoMu27_v14,HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_v13,HLT_Mu50_v12,HLT_DoubleMu43NoFiltersNoVtx_v3,HLT_Dimuon25_Jpsi_v13,DST_DoubleMu3_noVtx_CaloScouting_v5,HLTriggerFinalPath --output none --full --offline --mc --unprescale --process TEST --globaltag 92X_upgrade2017_realistic_v12 --l1-emulator FullMC --l1 L1Menu_Collisions2017_v4 --max-events 100 > hltConfig_debugger_mc.py`
...
You might also want to [rerun L1 emulator](https://twiki.cern.ch/twiki/bin/view/CMSPublic/SWGuideGlobalHLT#Running_the_HLT_with_CMSSW_9_2_X) if the sample is old:
