# /dev/CMSSW_8_0_0/GRun/V249 (CMSSW_8_0_19_patch2)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/dev/CMSSW_8_0_0/GRun/V249')
)
...
process.HLTSchedule = cms.Schedule( *(process.HLTriggerFirstPath, process.HLT_Mu50_v5, process.HLTriggerFinalPath ))
