...
if mode=="OIS":
	###OIState
	process.hltL3TrackCandidateFromL2.labels = cms.VInputTag( 'hltL3TrackCandidateFromL2OIState' )
	...
	process.hltL3TrajectorySeed.labels = cms.VInputTag( 'hltL3TrajSeedOIState' )
...
if mode=="OIH":
	###OIHit
	process.hltL3TrackCandidateFromL2.labels = cms.VInputTag( 'hltL3TrackCandidateFromL2OIHit' )
	...
	process.hltL3TrajectorySeed.labels = cms.VInputTag( 'hltL3TrajSeedOIHit' )
	process.hltL3TrajSeedOIHit.TkSeedGenerator.PSetNames = cms.vstring('iterativeTSG' ) #Force OIHit to run
...
process.TFileService = cms.Service("TFileService",
                                   fileName = cms.string("muonDebugger.root"),
