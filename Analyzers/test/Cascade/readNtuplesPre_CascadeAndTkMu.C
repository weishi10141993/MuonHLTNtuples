...
void readNtuplesPre_CascadeAndTkMu(TString inputfilename="/afs/cern.ch/user/s/sferrere/private/CMSSW_9_2_7/src/workspace/cascade/JSON_08_16/result.root", std::string effmeasured="Cascade_alignment"){
